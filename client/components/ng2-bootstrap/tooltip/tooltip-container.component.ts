...
@Component({
  ...
  template: `<div class="tooltip" role="tooltip"
     ...
     [ngClass]="classMap">
      ...
      <!--
      <div class="tooltip-inner" *ngIf="htmlContent && isTemplate">
...
export class TooltipContainerComponent implements AfterViewInit {
  ...
  public constructor(element: ElementRef, cdr: ChangeDetectorRef, @Inject(TooltipOptions) options: TooltipOptions) {
  ...
  public ngAfterViewInit(): void {
    ...
    let p = positionService
      .positionElements(
      this.hostEl.nativeElement, this.element.nativeElement.children[0],
